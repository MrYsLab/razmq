...
class Pfc8591EnableTester(Razbase):
    """
...
def pfc8591_enable_tester():
    parser = argparse.ArgumentParser()
    parser.add_argument("-b", dest="back_plane_ip_address", default="None",
                        help="None or IP address used by Back Plane")
    parser.add_argument("-n", dest="process_name", default="PFC8591 Enable Tester", help="Set process name in banner")
    ...
    my_tester = Pfc8591EnableTester(**kw_options)
