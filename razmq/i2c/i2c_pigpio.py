...
class I2cPigpio(Razbase):
    ...
    def __init__(self, router_ip_address=None, subscriber_port='43125', publisher_port='43124', board='1',
                 process_name=None):
    ...
    def report_i2c_block_data(self, data, tag):
        ...
        msg = umsgpack.packb({u"cmd": "I2C_reply", u"board": self.board_num, u"data_files": rdata, u"tag": tag})
    ...
    def report_i2c_byte_data(self, data, tag):
        # create a topic specific to the board number of this board
        envelope = ("I2C" + str(self.i2c_addr))
        msg = umsgpack.packb({u"cmd": "I2C_reply", u"board": self.board_num, u"data_files": data, u"tag": tag})
        self.publisher.send_multipart([envelope.encode(), msg])
