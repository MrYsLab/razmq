...
class I2CAdxl345(Razbase):
    """
    This class continuously reads accelerometer data_files. It may be stopped
    started by other processes that publish an adxl345 topic message with a payload of enable or
    disable
    ...
    def incoming_message_processing(self, topic, payload):
        ...
        try:
            ...
            print('adxl345 - Unexpected topic: ', topic)
            pass
...
def i2c_adxl345():
    ...
    parser.add_argument("-n", dest="process_name", default="ADXL345 Front End", help="Set process name in banner")
    ...
    my_i2c_adxl345 = I2CAdxl345(**kw_options)
